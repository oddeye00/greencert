...
where (mathcal D_\Delta=\operatorname{diag}(\Delta_0,ldots,Delta_{H-1})).
...
residual spectral certificate (arepsilon_s) nor derivative-envelope work;
both must be counted in an empirical benchmark.

## 6. Relation to established validation machinery
